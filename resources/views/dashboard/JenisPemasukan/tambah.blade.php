                        ...
                        <div class="mb-3">
                            <div class="form-group">
                              <h3 class="text-center mb-4">Tambah Data</h3>
                                <input type="text" id="kode" name="kode" class="form-control" placeholder="Kode Pemasukan">
                            </div>

                            <div class="form-group">
                            <form action="{{ route('simpan.pemasukan') }}" method="post">
                                {{ csrf_field() }}
                                <input type="date" id="tanggal" name="tanggal" class="form-control" placeholder="id_pemasukan">
                            </div>
                            <div class="form-group">
                                <input type="number" id="jumlah" name="jumlah" class="form-control" placeholder="Nama Pemasukan">
                            </div>
